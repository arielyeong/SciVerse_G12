        ...
        <div class="card shadow-lg p-4">
            ...
            <div class="row mb-4">
                <div class="col-md-7">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFullname" CssClass="text-danger" ErrorMessage="Full name is required." Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Age</label>
                        <asp:TextBox ID="txtAge" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAge" CssClass="text-danger" ErrorMessage="Age is required." Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtUsername" CssClass="text-danger" ErrorMessage="Username is required." Display="Dynamic"></asp:RequiredFieldValidator>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Email Address</label>
                    <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" CssClass="form-control"></asp:TextBox>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmail" CssClass="text-danger" ErrorMessage="Email is required." Display="Dynamic"></asp:RequiredFieldValidator>
                </div>
            </div>
            ...
            <asp:Label ID="lblMessage" runat="server" CssClass="d-block text-center text-danger mt-2"></asp:Label>
