<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewFlashcard.aspx.cs" Inherits="SciVerse_G12.Quiz_and_Flashcard.ViewFlashcard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="d-flex justify-content-between align-items-center">
        <a href="Flashcard.aspx" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left"></i>
        </a>
        
        <h2 class="text-center mt-0 pt-0 flex-grow-1">
            Flashcard for 
            <asp:Label ID="lblQuizName" runat="server"></asp:Label>
        </h2>
        </div>
 <div class="container-fluid my-7" style="height:30vh;">
     <asp:Panel ID="Panel1" runat="server" 
         ...
         <asp:Label ID="lblIndex" runat="server" CssClass="h4 d-block mb-4 text-wrap"></asp:Label>
         <asp:Label ID="lblQuestionType" runat="server" CssClass="h4 d-block mb-4 text-wrap text-black mb-2"></asp:Label>
