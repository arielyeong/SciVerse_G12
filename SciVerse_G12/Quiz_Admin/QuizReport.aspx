...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .kpi-title {
            display: block;
            margin-top: 18px;  /* push below accent bar */
            font-weight: 800;
            letter-spacing: .2px;
            color: #2b3340;
            text-align: center;
    ...
    <!-- === Results Table === --> <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="True" CssClass="table table-bordered table-hover" AllowPaging="True" PageSize="10" OnPageIndexChanging="gvReport_PageIndexChanging" OnSelectedIndexChanged="gvReport_SelectedIndexChanged"> <EmptyDataTemplate> 
